...
add wave -noupdate -expand -group {slave 0} -expand -group {s0 logic} -label {wD buffer} -radix hexadecimal {/top_tb/dut/SLAVE[0]/slave/wD_buffer}
add wave -noupdate -expand -group {slave 0} -expand -group {s0 logic} -label {rD buffer} -radix hexadecimal {/top_tb/dut/SLAVE[0]/slave/rD_buffer}
add wave -noupdate -expand -group {slave 0} -expand -group {s0 logic} -label {delay counter} -radix unsigned {/top_tb/dut/SLAVE[0]/slave/delay_counter}
add wave -noupdate -expand -group {slave 0} -expand -group {s0 logic} -label {config counter} -radix unsigned {/top_tb/dut/SLAVE[0]/slave/config_counter}
add wave -noupdate -expand -group {slave 0} -expand -group {s0 logic} -label {config buffer} {/top_tb/dut/SLAVE[0]/slave/config_buffer}
add wave -noupdate -expand -group {slave 0} -expand -group {s0 logic} -label {rD counter} -radix unsigned {/top_tb/dut/SLAVE[0]/slave/rD_counter}
add wave -noupdate -expand -group {slave 0} -expand -group {s0 logic} -label {wD counter} -radix unsigned {/top_tb/dut/SLAVE[0]/slave/wD_counter}
add wave -noupdate -expand -group {slave 0} -label address -radix unsigned {/top_tb/dut/SLAVE[0]/slave/address}
...
add wave -noupdate -expand -group {slave 1} -label address -radix unsigned {/top_tb/dut/SLAVE[1]/slave/address}
...
add wave -noupdate -group {slave 2} -group {s2 logic} -label {control counter} {/top_tb/dut/SLAVE[2]/slave/config_counter}
add wave -noupdate -group {slave 2} -group {s2 logic} -label {read counter} {/top_tb/dut/SLAVE[2]/slave/rD_counter}
add wave -noupdate -group {slave 2} -group {s2 logic} -label {write counter} {/top_tb/dut/SLAVE[2]/slave/wD_counter}
add wave -noupdate -group {slave 2} -group {s2 logic} -label {read data buffer} {/top_tb/dut/SLAVE[2]/slave/rD_buffer}
add wave -noupdate -group {slave 2} -group {s2 logic} -label {write data buffer} {/top_tb/dut/SLAVE[2]/slave/wD_buffer}
add wave -noupdate -group {slave 2} -group {s2 logic} -label {delay counter} -radix unsigned {/top_tb/dut/SLAVE[2]/slave/delay_counter}
add wave -noupdate -group {slave 2} -group {s2 logic} -label {control buffer} {/top_tb/dut/SLAVE[2]/slave/config_buffer}
add wave -noupdate -group {slave 2} -label address -radix unsigned {/top_tb/dut/SLAVE[2]/slave/address}
add wave -noupdate -group {slave 2} -label {comm. status} {/top_tb/dut/SLAVE[2]/slave/com_status}
add wave -noupdate -group {slave 2} -label state {/top_tb/dut/SLAVE[2]/slave/state}
...
WaveRestoreCursors {{Master done} {12610 ns} 0} {{Slave hold} {7870 ns} 0}
...
update
WaveRestoreZoom {11754 ns} {13511 ns}
